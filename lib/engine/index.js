...
function _buildCalc(definitions, clauses, forwardRules, queries, opts = {}) {
  ...
  // ── Shared rule filtering — Tier 1 (label list) + Tier 2 (module name) + grade-0 exclusion (T14) ──
  function filterRules(execOpts) {
    let rules = compiledRules;

    // Grade-0 exclusion: rules with grade-0 patterns are compile-time only (SELL/QTT)
