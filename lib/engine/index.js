...
function _buildCalc(definitions, clauses, forwardRules, queries, opts = {}) {
  ...
  // Measure layer (decimation driver + CI certifier) — attached via the
  // buildTimedApi registration pattern (RES_0143 M2); self-gated inside.
  Object.assign(api, buildCollapseApi(api, cc, sortSystem) || {});
  return api;
}
