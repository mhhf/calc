...
/**
 * Build sort table from types Map.
 * Iterates type declarations, parses arrow signatures, skips axioms.
 * @param {Map<string, number>} types - name → hash from convert.load()
 ...
 */
function checkAll(types, compiledRules, clauses, opts = {}) {
