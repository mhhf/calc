...
function _posterior(calc, state, e, sort) {
  // Domain: classifier members, or a datasort's subset of its base
  // (static conditioning — restriction, masses unchanged, B4). Dynamic
  // `within(e, S)` facts intersect further below.
