 ...
 */
function tryBackwardCache(goal, slots, theta, calc, wantTerm, canonicalize, ffiParsedModes, useFFI) {
...
module.exports = { tryBackwardCache, clearBackwardCache, getCacheProfile, resetCacheProfile };
