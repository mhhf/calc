 ...
 */
function drainLolis(state, linArena, perArena, calc, evidenceOut, matchOpts) {
  const rc = matchOpts?.connectives || (calc?.connectives ? resolveConn(calc.connectives) : null);
