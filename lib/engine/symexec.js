...
const { buildStateIndex } = require('./match');
const { findAllMatches, detectStrategy, makeFingerprintLayer, makeDiscTreeLayer,
        predicateLayer, buildStrategyStack } = require('./strategy');
