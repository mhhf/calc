...
const { filterPreserved } = require('./state-ops');
...
function mutateState(state, consumed, theta, linearPatterns, persistentPatterns, slots, rule, linArena, perArena) {
  // Inlined for V8 — cross-module calls to state-ops.js regress ~49%.
  // Canonical implementations: state-ops.js (used by forward.js).
