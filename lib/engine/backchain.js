...
const {
  compilePatternMatch, PM_BIND, PM_GROUND, PM_COMPOUND, _skipInstruction,
...
// Lazy ILL defaults — loaded on first use when no opts override provided.
// When called via index.js pipeline, backwardOpts from calculus config
// provides theories/normalize/tryFFI, so these defaults are unreached.
