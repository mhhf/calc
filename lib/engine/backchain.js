...
function getFirstArgHead(hash) {
  ...
  // Other compact literals (e.g. ratlit → 'rat') via the eq-theory registry.
...
export { backchain, prove, buildIndex };
export default { backchain, prove, buildIndex };
