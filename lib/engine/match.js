...
function _resolveValue(root, resolved) {
  // Iterative post-order traversal to resolve metavars in deep terms.
  ...
  if (tid0 === _TAG_METAVAR) { const r = resolved.get(root); return r !== undefined ? r : root; }
