...
function buildLnlProtocol({ matchLoli, resolveEx, drainLolis, rc, backchainUseFFI = false } = {}) {
  return {
...
export { getProfile, resetProfile, discIndex, fpDetect, fpValue, tryMatch, tryStateLookup, stateProvePersistent, PROVE_METHODS, PROVE_METHOD, buildGenericProtocol, buildLnlProtocol, buildOptProtocol, buildFfiProtocol, buildMatchOpts, EMPTY_MATCH_OPTS, GENERIC_FIELDS, LNL_FIELDS, OPT_FIELDS, FFI_FIELDS };
export default { getProfile, resetProfile, discIndex, fpDetect, fpValue, tryMatch, tryStateLookup, stateProvePersistent, PROVE_METHODS, PROVE_METHOD, buildGenericProtocol, buildLnlProtocol, buildOptProtocol, buildFfiProtocol, buildMatchOpts, EMPTY_MATCH_OPTS, GENERIC_FIELDS, LNL_FIELDS, OPT_FIELDS, FFI_FIELDS };
