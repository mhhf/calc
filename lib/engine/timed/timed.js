...
import { stampObservers, coalesce } from './coalesce.js';
// ─── Timed config ───────────────────────────────────────────────────
 ...
 *   therefore future PRF tie draws, never WHAT is reachable) }
...
function settle(inputState, rules, opts = {}) {
  ...
  const observers = doCoalesce ? stampObservers(ruleList, tcfg) : null;
