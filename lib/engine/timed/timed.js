...
function fire(state, m, tcfg, mult = 1) {
  ...
  if (rule.delay) {
    d = rule.delay.ground !== undefined ? rule.delay.ground
      : rule.delay.term !== undefined ? subApplyIdx(rule.delay.term, m.theta, m.slots)
      : m.theta[rule.delay.slot];
...
function _feedsInstant(m, tcfg, acc) {
  ...
  if (rule.delay) {
    let d = rule.delay.ground !== undefined ? rule.delay.ground
      : rule.delay.term !== undefined ? subApplyIdx(rule.delay.term, m.theta, m.slots)
      : m.theta[rule.delay.slot];
    if (d !== undefined && tcfg.canonStamp) d = tcfg.canonStamp(d);
    if (d !== undefined && tcfg.isStamp(d) &&
...
export {
  ...
  isAt, innerOf, stampOf, loliCandidates, INT_TAG,
};
export default {
  buildTimedConfig, normalizeTimedState, tryTimedMatch, fire,
  settle, settleChunked, nextActivation, settleExplore, settleFrontier,
