...
export { computationRole, resolveConn, flattenAnte, unwrapComp, expandChoice, expandConsqChoices };
export default { computationRole, resolveConn, flattenAnte, unwrapComp, expandChoice, expandConsqChoices };
