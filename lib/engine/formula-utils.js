  ...
  function walk(hash) {
    ...
    if (t === productTag) {
      ...
      if (grade === g0) {
        ...
        // gradeOmega (or any future grade with structural rules) → persistent
...
export { computationRole, ILL_COMPUTATION, resolveConn, flattenAnte, unwrapComp, expandChoice, expandConsqChoices };
export default { computationRole, ILL_COMPUTATION, resolveConn, flattenAnte, unwrapComp, expandChoice, expandConsqChoices };
