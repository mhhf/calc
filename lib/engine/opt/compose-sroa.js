 ...
 * this pass via composeOpts.fusePasses.sroa from the composition root.
 */
...
export { _sroa as sroa, _mccarthy, _trySROA };
export default { sroa: _sroa };
