...
function controlHash(state, controlOpts) {
  // Control predicates are LOGIC POLICY: the defaults ('pc'/'stack') are the
  // EVM instance, kept for caller compat; any other calculus passes its own
  // { pcPred, stackPred } via controlOpts (from calculusConfig.domain
  // .memoControlTags — TODO_0265 Phase 2b; till supplies its own, Phase 4).
