...
function _composeFullKey(compiledRules, clauses, definitions) {
 ...
 */
function composeGrade0(compiledRules, connectives, getModeMeta, clauses, definitions) {
  ...
  const fullKey = _composeFullKey(compiledRules, clauses, definitions);
