...
import { newPairProf, emitFuseScanDetect, emitFuseProfile, emitTablingProfile } from './compose-profile.js';
...
const _POOL_DISJOINT_ENABLED = process.env.CALC_POOL_DISJOINT !== '0';
...
export { cutPair, specialize, predMap, elimOrder, compose0, _fuseChains, _resolveOnce, _sroa, _tablingCacheKey, _composeFullKey, sortGoals, fusePair, fusePairEx };
export default { cutPair, specialize, predMap, elimOrder, compose0, _fuseChains, _resolveOnce, _sroa, _tablingCacheKey, _composeFullKey, sortGoals, fusePair, fusePairEx };
