...
const DEFAULT_LOADER_CONFIG = {
  buildParser: null,
  connTags: {
    computation: { tag: 'monad', bodyIdx: 0, gradeIdx: null },
    implication: 'loli',
    product: 'tensor',
    exponential: 'bang',
    preserved: 'preserved',
...
function loadFile(filePath, definitions, clauses, forwardRules, queries, opts = {}) {
  ...
  for (const decl of decls) {
    ...
    cleanBodyHash = desugarPreserved(cleanBodyHash, _ct.computation, _ct);
...
export { load, loadFile, parseExpr, hasMonad, decomposeQuery, desugarPreserved, buildImportTree, computeTreeHashes, extractTopLevelImports, stripNamedArgsFromArrowChain, resolveNamedArgSentinels, DEFAULT_LOADER_CONFIG };
export default { load, loadFile, parseExpr, hasMonad, decomposeQuery, desugarPreserved, buildImportTree, computeTreeHashes, extractTopLevelImports, stripNamedArgsFromArrowChain, resolveNamedArgSentinels, DEFAULT_LOADER_CONFIG };
