...
const { resolveConn, compileRule, flattenAnte, unwrapComp, expandChoice, expandConsqChoices } = require('./compile');
const match = require('./match');
const strategy = require('./strategy');
const { clearBWCache: lnlClearCache } = require('./backward-cache');
const { fromObject, toObject } = require('./fact-set');
const { consume, produce, producePers } = require('./state-ops');
const { EqNeqSolver } = require('./constraint');
const { satFilter } = require('./constraint-feed');
...
function run(inputState, rules, opts = {}) {
  ...
  const fwdStrategy = strategy.detectStrategy(ruleList);
