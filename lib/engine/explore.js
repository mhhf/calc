...
import { buildFingerprintIndex, _rejectWindowRules } from './forward.js';
import { tryMatch, EMPTY_MATCH_OPTS } from './match.js';
import { clearBWCache as lnlClearCache } from './backward-cache.js';
import { findAllMatches, detectStrategy } from './strategy.js';
...
import { feedPers, satFilter } from './constraint-feed.js';
// --- Cycle detection ---
...
function explore(initialState, rules, opts = {}) {
  ...
  const drainLolis = matchOpts.drainLolis;
