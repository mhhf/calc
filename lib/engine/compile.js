...
function expandItem(h) {
  ...
  if (t === 'exists') {
    ...
    const mv = Store.put('freevar', ['_ex' + _existsCounter++]);
    const opened = debruijnSubst(body, 0n, mv);
