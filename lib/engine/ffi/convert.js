...
function isGround(h) {
  ...
  // Arrlit: concrete container — ground for FFI dispatch regardless of element groundness.
  // FFI ops (arr_get, arr_set, arr_len) operate on the container, not element values.
  if (t === 'arrlit') return true;
