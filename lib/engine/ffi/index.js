...
register('memory.mem_read_range', memory.mem_read_range);
register('memory.no_overlap', memory.no_overlap);
register('memory.overlaps', memory.overlaps);
register('memory.splice', memory.splice);
register('memory.splice_byte', memory.splice_byte);
...
const defaultMeta = {
  ...
  mem_read_range: { ffi: 'memory.mem_read_range', mode: '+ + + -' },
  no_overlap: { ffi: 'memory.no_overlap', mode: '+ + + +' },
  overlaps: { ffi: 'memory.overlaps', mode: '+ + + +' },
  splice: { ffi: 'memory.splice', mode: '+ + + + -' },
  splice_byte: { ffi: 'memory.splice_byte', mode: '+ + + + -' },
};
