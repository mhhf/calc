 ...
 * and ephemeral rewriting (binlit ↔ o/i/e).
 *
 ...
 */
function ephemeralRewrite(srcTid, srcHash, dstTid, dstArity) {
...
module.exports = { normalize, buildClauseTerm, tryFFI, ephemeralRewrite, getFFIMeta };
