...
/** Unit grade of the graded lax monad (TODO_0157 D6 merge-back): binlit 0,
 *  the canonical putRat(0,1) form — ILL's `{A}` is monad(monadUnit(), A),
 *  hash-identical to till's zero-delay `{A}`. Recomputed on demand (see
 *  the module comment: captured Store IDs go stale across reindexing). */
