...
register('array.trie_get', array.trie_get);
register('array.trie_set', array.trie_set);
...
const defaultMeta = {
  ...
  trie_get: { ffi: 'array.trie_get', mode: '+ + -' },
  trie_set: { ffi: 'array.trie_set', mode: '+ + + -' },
  ...
  is_push: { ffi: 'arithmetic.is_push', mode: '+ -', range: { lo: 0x60, hi: 0x7f } },
  is_dup: { ffi: 'arithmetic.is_dup', mode: '+ -', range: { lo: 0x80, hi: 0x8f } },
  is_swap: { ffi: 'arithmetic.is_swap', mode: '+ -', range: { lo: 0x90, hi: 0x9f } },
};
