 ...
 *
 * Unifies three previously scattered implementations:
 *   - match.js:_normalizeBin — canonicalize structural binary to compact binlit
 *   - backchain-ill.js:normalize — same canonicalization for backward prover
 *   - backchain-ill.js:eqRewrite — cross-tag rewriting for clause head matching
 *
