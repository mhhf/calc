...
/** ILL clause proof term builder (default instance — the graded monad
 *  with the trivial unit grade, D6 merge-back). */
const buildClauseTerm = makeClauseTermBuilder({ gradeUnit: monadUnit });
