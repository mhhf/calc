...
const { isPredTag, predHead: getHead, rTensor } = require('../../kernel/ast');
...
function buildClauseTerm(groundPrems, premTerms, groundHead) {
  const { GRADE_W } = require('../../engine/grades');
...
module.exports = { initILL, normalize, buildClauseTerm, buildFFITerm, buildTypeTerm, tryFFI, getFFIMeta, makeILLBackchainOpts };
