...
import { GRADE_W } from '../../engine/grades.js';
...
function buildClauseTerm(groundPrems, premTerms, groundHead) {
  ...
  const bangPrems = groundPrems.map(p => Store.put('bang', [GRADE_W, p]));
...
export { initILL, normalize, buildClauseTerm, buildFFITerm, buildTypeTerm, tryFFI, getFFIMeta, makeILLBackchainOpts };
export default { initILL, normalize, buildClauseTerm, buildFFITerm, buildTypeTerm, tryFFI, getFFIMeta, makeILLBackchainOpts };
