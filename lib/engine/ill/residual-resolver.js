/**
 * Compile-time residual resolver for persistent arithmetic goals.
 *
 ...
 *
 * Each predicate mirrors its FFI implementation in arithmetic.js but returns
 * a complete fact hash (all positions filled) instead of a substitution.
 */
