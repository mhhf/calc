...
import { tryMatch, fpDetect, fpValue, EMPTY_MATCH_OPTS } from './match.js';
...
export { fpLayer, buildStack, detectStrategy, attachPred, makeDiscTreeLayer, findMatch, findAllMatches };
export default { fpLayer, buildStack, detectStrategy, attachPred, makeDiscTreeLayer, findMatch, findAllMatches };
