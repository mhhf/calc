 ...
 *   intern('binlit', [42n])      -> hash4, stores { tag: 'binlit', children: [42n] }
 *   intern('strlit', ['hello'])  -> hash5, stores { tag: 'strlit', children: ['hello'] }
 *   intern('charlit', [97])      -> hash6, stores { tag: 'charlit', children: [97] }
 */
