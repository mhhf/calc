 ...
 * Returns constructors that produce content-addressed hashes via Store.intern.
 */
...
/**
 * Build precedence-climbing parser from constructor annotations.
 * Uses @prec/@ascii annotations to generate an operator table.
 */
...
/**
 * Build renderer from constructor annotations.
 * Handles both hashes (numbers via Store) and raw AST objects.
 */
...
module.exports = { buildAST, buildParser, buildRenderer };
