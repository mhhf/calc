...
export { put, put1, put2, put3, get, tag, tagId, children, child, rawChild, arity, isTerm, isTermChild, isGround, eq, clear, size, snapshot, restore, TAG, TAG_NAMES, PRED_BOUNDARY, registerTag, getArrayElements, putArray, onClear, onReplace, LEAF_TAGS };
export default { put, put1, put2, put3, get, tag, tagId, children, child, rawChild, arity, isTerm, isTermChild, isGround, eq, clear, size, snapshot, restore, TAG, TAG_NAMES, PRED_BOUNDARY, registerTag, getArrayElements, putArray, onClear, onReplace, LEAF_TAGS };
