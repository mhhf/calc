...
//   gmonad  — graded monad gmonad(grade, body): the binary lax monad
//             ({B}@d in till); ILL's unary 'monad' stays untouched (D6)
['atom', 'freevar', 'metavar', 'tensor', 'loli', 'with', 'bang', 'one', 'type',
 ...
 'ratlit', 'at', 'after', 'before', 'gmonad'].forEach(registerTag);
