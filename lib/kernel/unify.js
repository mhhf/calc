...
export { unify, match, matchIndexed, undoSave, undoRestore, undoDiscard, isMetavar, setTheories, theoryFor, canCrossMatch };
export default { unify, match, matchIndexed, undoSave, undoRestore, undoDiscard, isMetavar, setTheories, theoryFor, canCrossMatch };
