...
export { unify, match, matchIndexed, undoSave, undoRestore, undoDiscard, isMetavar, setTheories };
export default { unify, match, matchIndexed, undoSave, undoRestore, undoDiscard, isMetavar, setTheories };
