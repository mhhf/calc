...
module.exports = grammar({
  ...
  rules: {
    // Program is a list of declarations and directives
    source_file: $ => repeat(choice($.declaration, $.directive)),
    ...
    expr: $ => choice(
      ...
      prec.right(1, seq($.expr_with, '->', $.expr)),
      // Forward rule: A -o { B }
      prec.right(1, seq($.expr_with, '-o', '{', $.expr, '}')),
    ...
    expr_with: $ => choice(
      prec.left(2, seq($.expr_with, '&', $.expr_tensor)),
      $.expr_tensor,
    ),
    ...
    expr_tensor: $ => choice(
      prec.left(3, seq($.expr_tensor, '*', $.expr_bang)),
      $.expr_bang,
    ),
    ...
    expr_app: $ => choice(
      prec.left(4, seq($.expr_app, $.expr_atom)),
      $.expr_atom,
    ),
