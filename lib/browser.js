...
const { buildAST, buildParser, parserFromTables, buildRenderer, rendererFromFormats, deriveRoles } = require('./calculus/builders');
...
module.exports = {
  ...
  sequentParser:  ()     => ensureInit().sequentParser(),
