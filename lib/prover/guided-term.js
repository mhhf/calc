 ...
 *
 * The clause case uses id(goal) as a placeholder: the engine's lightweight
 * backward prover (lib/engine/prove.js) returns only substitutions, not
 * proof terms. The ZK witness generator handles this by routing clause-proved
 * goals to the ffi chip (absorbs obligation without structural proof).
 * Full clause proof tree extraction requires extending prove.js with term output.
 */
