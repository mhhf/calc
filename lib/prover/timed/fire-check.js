...
const fireChecker = Object.freeze({
  step(conclusion, state, { calculus, program }) {
    ...
    return checkFireData(conclusion, state && state.fire,
      { program, theory: calculus.theory, config: calculus.fire });
  },
...
export { checkFireData, checkFireTreeStep, subst, fireChecker };
export default { checkFireData, checkFireTreeStep, subst, fireChecker };
