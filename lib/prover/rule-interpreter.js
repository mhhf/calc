...
let _metavarCounter = 0;
function freshMetavar() {
  return Store.put('freevar', ['_w' + _metavarCounter++]);
}
function resetMetavarCounter(val = 0) { _metavarCounter = val; }
...
module.exports = { buildRuleSpecs, computeRuleSpecMeta, buildRuleSpecsFromMeta, resetMetavarCounter };
