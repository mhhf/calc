...
class FocusedProofState {
  ...
  toString() {
    ...
    return `focus(${this.position}${this.focusHash ? ':' + this.focusHash.toString(16).slice(0, 8) : ''})`;
  }
...
export { FocusedProofState, inversion, focus };
export default { FocusedProofState, inversion, focus };
