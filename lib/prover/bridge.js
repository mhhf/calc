 ...
 *  (lib/prover/ill/guided-term.js) and the generic bridge stays free of
...
function modeSwitch(seq, engineCalc, opts = {}, ruleName = null, calculus = null) {
  ...
  if (guided) {
    ...
    if (!_guidedTerm) {
      throw new Error("bridge: guided profile has no registered term builder — import the calculus's guided-term module (e.g. lib/prover/ill/guided-term.js self-registers)");
    }
