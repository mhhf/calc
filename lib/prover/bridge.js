...
const { monadicTerm } = require('./generic-term');
const { guidedTerm } = require('./guided-term');
...
module.exports = { sequentToState, stateToContext, rightFocus, rightFocusTerm, modeSwitch };
