...
import { apply as subApply } from '../kernel/substitute.js';
...
export { empty, fromArray, toArray, size, isEmpty, add, remove, has, merge, subtract, contains, eq, substitute, find, filter, entries };
export default { empty, fromArray, toArray, size, isEmpty, add, remove, has, merge, subtract, contains, eq, substitute, find, filter, entries };
