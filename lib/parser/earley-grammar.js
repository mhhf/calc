...
function _buildGrammar(tables) {
  ...
  // Auxiliary sorts: every template hole whose sort differs from the
  // template's return sort targets the ONE literal/expression chain
  ...
  // guarded sort semantics the parser no longer owns.
