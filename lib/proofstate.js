...
Proofstate.getInvertableRule = function (pt, o) {
  ...
  let succPositive =
    ...
    && succedent.ruleConstructor !== "Formula_Atprop")
    // && succedent.ruleConstructor !== "Structure_Focused_Term_Formula"
      // TODO - clean this by having a ! .isAtomic
    && succedent.vals[1].isNegative({calc: o.calc, positive: [], negative: []});
...
Proofstate.auto = function(pt, o) {
  ...
  let invertableId = Proofstate.getInvertableRule(pt, {calc: o.calc, positive: [], negative: []});
