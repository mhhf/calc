...
const { buildAST, buildParser, buildRenderer, computeConnectivesByType, deriveRoles } = require('./builders');
...
function buildCalculus(spec, rules = {}) {
  ...
  // Inject monad rules only if calculus defines a monad connective
  if (constructors.monad) {
