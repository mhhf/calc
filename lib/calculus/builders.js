 ...
 *
 * Parser: buildParserFromTables delegates to the Earley parser engine
 * (lib/parser/earley-grammar.js). computeParserTables extracts operator
 * metadata from constructor annotations (serializable for ill.json bundle).
 *
 * Renderer: computeRendererFormats is separated from buildRendererFromFormats
