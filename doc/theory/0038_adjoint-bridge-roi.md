...
token class live in a declared mode and DELETE the special-casing —
the same trade the audit made everywhere else (declared structure over
ad-hoc mechanism).
