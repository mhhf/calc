...
references:
  ...
  - "THY_0001 (exhaustive forward chaining — the world-set the denotation refines), THY_0016 (partial evaluation as cut elimination — forced elimination is its runtime instance), TODO_0002 (the eigenvariable decision this document gives the metatheory for), TODO_0005 (constraint propagation = the engine's future consistency/pruning layer), TODO_0307 (the incident, isolation, and implementation corollary)."
---
...
(force) — is the implementation corollary, not the theory (TODO_0307;
branch todo-0307-eager-eigenvariable pins it with a four-mode equivalence
gate, the executable shadow of Theorems 1–2).
