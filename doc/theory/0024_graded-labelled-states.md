...
paper: "FULLY compiled (core results) into doc/paper/till (calc c712242b, 2026-08-23) — label algebra, graded firing law, representation adequacy (= paper Lem 8.1), covariant-draw corollary, and address stability in §8; the engine-facing what-stays-internal/observer-boundary detail is condensed to §8 prose."
