...
paper: "FULLY compiled into doc/paper/till (calc c712242b, 2026-08-23) — paper §5 (timed matching, match order, scheduler, windows, read arcs; determinism/composability/termination as Thms 5.3–5.4). §6's open questions appear only as future-work mentions."
