...
paper: "FULLY compiled (theory content) into doc/paper/till (calc c712242b, 2026-08-23) — fenced algebras + Grade Preservation = paper Thm 2.1 (§2), residual-as-backward-plus and residuation-as-price-of-internalization in §§2–3, adequacy bridge statement in §6. Repo-facing parts stay here only: §3 implementation map, §7 deliberately-not-adopted alternatives."
