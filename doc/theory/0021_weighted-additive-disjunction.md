...
paper: "PARTIALLY compiled into doc/paper/till (calc c712242b, 2026-08-23) — paper §3 woplus subsection carries the weighted rules, the Mass Conservation STATEMENT, and the duel≅DP correspondence as a remark; seeded-PRF replay determinism appears as a §8 remark. NOT compiled (reserved for the future {A}_w paper, TODO_0270 decision): the probability-graded judgment's full treatment, the mass-conservation and absorbing-chain PROOFS (§§4–5), the unbiased-estimator theorem (§6), weighted cut (§7)."
