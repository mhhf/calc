...
### Mapping Authorization Concepts
...
```
- Add ownership modality to ll.json
...
## Open Problems and Our Contribution
...
3. **Multi-type DC for authorization**: Existing work uses:
   - Standard sequent calculus
   - Labeled sequent calculus
   But not multi-type display calculus with adjoint decomposition.
