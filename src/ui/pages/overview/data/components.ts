...
export const COMPONENTS: Component[] = [
  ...
  // ─── Forward Engine: LNL Layer ─────────────────────────────────────
  {
    ...
    files: ['family/lnl/lib/persistent.js'],
    trust: 'infrastructure', specificity: 'logic',
    stages: ['execute'], modes: ['forward', 'symbolic'],
  ...
  },
  {
    ...
    files: ['family/lnl/lib/loli-drain.js'],
    trust: 'infrastructure', specificity: 'logic',
    stages: ['execute'], modes: ['forward'],
    deepDive: 'engine', cluster: 'engine.lnl',
  },
  {
    ...
    files: ['family/lnl/lib/existential.js'],
    trust: 'infrastructure', specificity: 'logic',
    stages: ['execute'], modes: ['forward', 'symbolic'],
    deepDive: 'engine', cluster: 'engine.lnl',
  },
  ...
  // ─── Forward Engine: ILL Layer (logic) ─────────────────────────────
  {
    ...
    files: ['calculus/ill/calculus-config.js'],
    trust: 'infrastructure', specificity: 'logic',
  ...
  },
  {
    ...
    files: ['calculus/ill/lib/backchain-ill.js'],
    trust: 'infrastructure', specificity: 'logic',
    stages: ['execute'], modes: ['backward'],
    deepDive: 'engine', cluster: 'engine.ill',
  },
  {
    ...
    files: ['calculus/ill/lib/binlit-theory.js'],
  ...
  },
  {
    ...
    files: ['calculus/ill/lib/bytecode-normalize.js'],
  ...
  },
  {
    ...
    files: ['calculus/ill/lib/connectives.js'],
    trust: 'infrastructure', specificity: 'logic',
