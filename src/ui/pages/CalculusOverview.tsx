                        ...
                        <tr>
                          ...
                          <td class="px-3 py-2">
                            <span
                              class="px-2 py-0.5 text-xs rounded"
                              classList={{
                                'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400': info.polarity === 'positive',
                                'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400': info.polarity === 'negative',
                              }}
                            >
                              {info.polarity}
                            </span>
