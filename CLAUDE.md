...
├── calculus-config.js   # Composes gill's exported layer pieces (M2); scheduler chooser 'entropy' (M5); binderSorts grammar opt-in (∃_ρ); backward fragment = gill.rules BY REFERENCE
