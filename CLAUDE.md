...
│   ├── datasort-mass.js # Inside-mass solver (fence B) — CALCULUS-BOUND oracle machinery, not core: will's config binds it (cc.datasortMasses); the checker never imports it
