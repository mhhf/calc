 ...
 * predicates (`cc.domain.constraintPreds` = {eq, neq} for ILL); the solver IS
 * their decision procedure. Predicates the calculus does NOT declare decidable
 * are opaque assertions and are NEVER pruned (soundness: no completeness loss).
 * Extending the fragment to certified-total predicates (lt/gt/…), and the exec
 * committed-choice path, belong to the mode system (task #81 / P7).
 */
