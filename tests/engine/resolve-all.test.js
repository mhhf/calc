...
function collectFacts(goals, template) {
  setup();
  const solutions = resolve(goals, clauses, definitions, { maxSolutions: 10000 });
  const seen = new Map();
...
describe('resolve-all: compile-time SLD resolution', () => {
  ...
  describe('basic arithmetic', () => {
    it('plus(1, 1, OP) yields exactly 1 solution (OP=2)', () => {
      ...
      const solutions = resolve([goal], clauses, definitions);
  ...
  describe('native between enumeration', () => {
    ...
    it('between with ground X acts as membership check', () => {
      ...
      const sol1 = resolve([goal1], clauses, definitions);
      ...
      const sol2 = resolve([goal2], clauses, definitions);
  ...
  describe('maxSolutions guard', () => {
    it('throws when solutions exceed limit', () => {
      ...
      assert.throws(
        () => resolve([goal], clauses, definitions, { maxSolutions: 50 }),
